        ...
        <Container>
          <Row>
            <Col md={12} xs={12}>
              ...
              >
                <SectionHeading heading="Contact Us" subHeading="" />
                <Row>
                  <Col md={6} xs={12}>
                    <p
                      class="mb-0 mt-2 font-italic"
                      style={{ fontSize: "16px", color: "#454040" }}
                    >
                      Your Order is just a call or text away- 6371830551
                      <br />
                      For details mail us at{" "}
                      <a href="mailto:info@fooddude.in">info@fooddude.in</a>
                      <br />
                      We are also available and accessbile at-
                      <br />
                      <br />
                      <FontAwesome icon="instagram" className="fa-2x" />
                      &nbsp;&nbsp;
                      <a href="https://www.instagram.com/wefooddude/">
                        wefooddude
                      </a>
                      <br />
                      <br />
                      <FontAwesome icon="facebook" className="fa-2x" />
                      &nbsp;&nbsp;
                      <a href="https://www.facebook.com/wefooddude/">
                        Food Dude
                      </a>
                      <br />
                      <br />
                      <FontAwesome icon="linkedin" className="fa-2x" />
                      &nbsp;&nbsp;
                      <a href="https://in.linkedin.com/company/wefooddude">
                        Food Dude
                      </a>
                      <br />
                      <br />
                      <FontAwesome icon="twitter" className="fa-2x" />
                      &nbsp;&nbsp;
                      <a href="https://mobile.twitter.com/wefooddude">
                        wefooddude
                      </a>
                      <br />
                      <br />
                  ...
                  <Col md={6} xs={12} style={{ marginTop: "50px" }}>
                    ...
                    >
                      ...
                      <div style={{ textAlign: "center" }}>
                        Lane-5A, Gouri Nagar, Old Town Samantarapur,
                        <br /> Bhubaneswar, Khordha, Odisha <br />
                        Pincode-751002
                      </div>
                    </p>
                  </Col>
